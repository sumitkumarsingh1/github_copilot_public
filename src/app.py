...
activities = {
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "christopher@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and explore scientific concepts through interactive projects",
